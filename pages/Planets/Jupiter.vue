<template>
  <div>
    <div id="" class="planet">
      <div id="images">
        <img class="planet_images img-fluid"  src="../../assets/img/planets/jupiter.jpg" alt="Jupitor">
        <img class="planet_images img-fluid"  src="../../assets/img/planets/jupiter_moons.jpg" alt="Earth" style="float:left;">
        <img class="planet_images img-fluid"  src="../../assets/img/planets/jupiter_inside.png" alt="Earth" style="float:left;">
      </div>
      <div class="planet_info">
        <h5 class="planet_name">JUPITER</h5>
        <h6 class="planet_info">
          Jupiter is the largest planet in the solar system. Fittingly, it was named after the king of the gods in Roman mythology. In a similar manner, the ancient Greeks named the planet after Zeus, the king of the Greek pantheon.
            Jupiter helped revolutionize the way we saw the universe and ourselves in 1610, when Galileo discovered Jupiter's four large moons — Io, Europa, Ganymede and Callisto, now known as the Galilean moons. This was the first time that celestial bodies were seen circling an object other than Earth,
            major support of the Copernican view that Earth was not the center of the universe.<br> Physical characteristics
            Jupiter is the most massive planet in our solar system, more than twice as massive as all the other planets combined, and had it been about 80 times more massive, it would have actually become a star instead of a planet. Its atmosphere resembles that of the sun, made up mostly of hydrogen and helium, 
            and with four large moons and many smaller moons in orbit around it, Jupiter by itself forms a kind of miniature solar system.
            All told, the immense volume of Jupiter could hold more than 1,300 Earths.<br>
            ...
            The magnetosphere of Jupiter, which is composed of these fields and particles, swells out some 600,000 to 2 million miles (1 million to 3 million km) toward the sun and tapers to a tail extending more than 600 million miles (1 billion km) behind Jupiter.
            ...
            Chemical composition: Jupiter has a dense core of uncertain composition, surrounded by a helium-rich layer of fluid metallic hydrogen, wrapped up in an atmosphere primarily made of molecular hydrogen.<br>
            <br><span class="highlight_text">Internal structure:</span><br>
            ...
            Aphelion (farthest distance from the sun): 507,089,500 miles (816,081,400 km). By comparison: 5.366 times that of Earth.<br><br>
            <span class="highlight_text">Jupiter's moons</span><br>
            ...
            The moon has at least one thick ocean between layers of ice, although it may contain several layers of both materials. 
            This moon will be the main target of the European Jupiter Icy Moons Explorer (JUICE) that will launch in 2022 and arrive at Jupiter's system in 2030.
            Io is the most volcanically active body in our solar system. The sulfur its volcanoes spew out gives Io a blotted yellow-orange appearance that is often compared to a pepperoni pizza. 
            As Io orbits Jupiter, the planet's immense gravity causes "tides" in Io's solid surface that rise 300 feet (100 meters) high, generating enough heat for volcanic activity.
            The frozen crust of Europa is made up mostly of water ice, and it may hide a liquid ocean holding twice as much water as Earth does. Icy oceans may also exist beneath the crusts of Callisto and Ganymede. 
            ...
            Callisto has the lowest reflectivity, or albedo, of the four Galilean moons. This suggests that its surface may be composed of dark, colorless rock.<br><br>
            <span class="highlight_text">Jupiter's rings</span><br>
