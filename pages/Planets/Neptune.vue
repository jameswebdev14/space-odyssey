<template>
  <div class="planet">
    ...
    <div class="planet_info">
      ...
      While Neptune is of interest because it is in our own solar system, astronomers are also interested in learning more about the planet to assist with exoplanet studies. Specifically, some astronomers are interested in learning about the habitability of worlds that are somewhat bigger than Earth.<br><br>
      ...
      Like Earth, Neptune has a rocky core, but it has a much thicker atmosphere that prohibits the existence of life as we know it. Astronomers are still trying to figure out at what point a planet is so large that it may pick up a lot of gas in the area, making it difficult or impossible for life to exist.<br><br>
      ...
      By studying the cloud formations on the gas giant, scientists were able to calculate that a day on Neptune lasts just under 16 hours.<br><br>
      ...
      Every 248 years, Pluto moves inside Neptune's orbit for 20 years or so, during which time it is closer to the sun than Neptune. Nevertheless, Neptune remains the farthest planet from the sun, since Pluto was reclassified as a dwarf planet in 2006.<br><br>
      ...
      Composition: The overall composition of Neptune is, by mass, thought to be about 25 percent rock, 60 to 70 percent ice, and 5 to 15 percent hydrogen and helium, according to Tristan Guillot, author of "Interiors of Giant Planets Inside and Outside the Solar System" in the journal Science.<br><br>
      <span class="highlight_text">Internal structure:</span><br>
      Mantle of water, ammonia and methane ices; Core of iron and magnesium-silicate<br><br>
      ...
      Aphelion (farthest distance from the sun): 2,819,080,000 miles (4,536,870,000 km). By comparison: 30.326 times that of Earth.<br><br>
      <span class="highlight_text">Neptune's moons</span><br>
