    ...
    <div class="planet">
      ...
      <div class="planet_info">
        ...
        <h6 class="planet_info"> Earth, our home, is the third planet from the sun.<br>
          ...
          arth's formation and evolution. Scientists think Earth was formed at roughly the same time as the sun and other planets some 4.6 billion years ago, when the solar system coalesced from a giant, rotating cloud of gas and dust known as the solar nebula. As the nebula collapsed because of its gravity, it spun faster and flattened into a disk. Most of the material was pulled toward the center to form the sun.
          ...
          Radioactive materials in the rock and increasing pressure deep within the Earth generated enough heat to melt the planet's interior, causing some chemicals to rise to the surface and form water, while others became the gases of the atmosphere. Recent evidence suggests that Earth's crust and oceans may have formed within about 200 million years after the planet took shape.</h6>
          <h6>
          ...
          <br><br><span class="highlight_text">Magnetic field</span><br>
          ...
          <br><br><span class="highlight_text">Earth's atmosphere</span><br>
          ...
          <ul class="planet_facts highlight_text">
            ...
            <li>Length of solar day (single rotation on its axis): 23.934 hours</li>
            <li>Length of year (single revolution around the sun): 365.26 days</li>
            <li>Equatorial inclination to orbit: 23.4393 degrees</li>
          </ul>
      </div>
    </div>
