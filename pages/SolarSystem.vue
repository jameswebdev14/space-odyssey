...
<div>
  <div id="solar">
    ...
    <div class="info">
      <h6 class="info">
      The Universe is a very big place, and we occupy a very small corner of it.<br>
      Known as the Solar System, our stomping grounds are not only a tiny fraction of the Universe as we know it, but is also a very small part of our galactic neighborhood (aka. the Milky Way Galaxy).<br>
      When it comes right down to it, our world is just a drop of water in an endless cosmic sea.<br>
      Nevertheless, the Solar System is still a very big place, and one which is filled with its fair share of mysteries. And in truth, it was only within the relatively recent past that we began to understand its true extent.<br>
      And when it comes to exploring it, we’ve really only begun to scratch the surface.<br><br>
      <span class="highlight_text">Discovery</span><br>
      ...
      Also in 1992, astronomers David C. Jewitt of the University of Hawaii and Jane Luu of the MIT discovered the Trans-Neptunian Object (TNO) known as (15760) 1992 QB1.<br>This would prove to be the first of a new population, known as the Kuiper Belt, which had already been predicted by astronomers to exist at the edge of the Solar System.<br>
      Further investigation of the Kuiper Belt by the turn of the century would lead to additional discoveries. The discovery of Eris and other “plutoids” by Mike Brown, Chad Trujillo, David Rabinowitz and other astronomers would lead to the Great Planet Debate – where IAU policy and the convention for designating planets would be contested.</span><br><br>
      <span class="highlight_text">Structure & Composition</span><br>
      ...
      The Sun contains 99.86% of the system’s known mass, and its gravity dominates the entire system. Most large objects in orbit around the Sun lie near the plane of Earth’s orbit (the ecliptic) and most planets and bodies rotate around it in the same direction (counter-clockwise when viewed from above Earth’s north pole).<br>
      The planets are very close to the ecliptic, whereas comets and Kuiper belt objects are frequently at greater angles to it.
      It’s four largest orbiting bodies (the gas giants) account for 99% of the remaining mass, with Jupiter and Saturn togethr comprising more than 90%. The remaining objects of the Solar System (including the four terrestrial planets, the dwarf planets, moons, asteroids, and comets) together comprise less than 0.002% of the Solar System’s total mass.<br>
      Astronomers sometimes informally divide this structure into separate regions. First, there is the Inner Solar System, which includes the four terrestrial planets and the Asteroid Belt. Beyond this, there’s the outer Solar System that includes the four gas giant planets.<br>Meanwhile, there’s the outermost parts of the Solar System are considered a distinct region consisting of the objects beyond Neptune (i.e. Trans-Neptunian Objects).
      ...
      The Sun, which comprises nearly all the matter in the Solar System, is composed of roughly 98% hydrogen and helium. The terrestrial planets of the Inner Solar System are composed primarily of silicate rock, iron and nickel.<br>Beyond the Asteroid Belt, planets are composed mainly of gases (such as hydrogen, helium) and ices – like water, methane, ammonia, hydrogen sulfide and carbon dioxide.
      Objects farther from the Sun are composed largely of materials with lower melting points. Icy substances comprise the majority of the satellites of the giant planets, as well as most of Uranus and Neptune (hence why they are sometimes referred to as “ice giants”) and the numerous small objects that lie beyond Neptune’s orbit.<br>
      Together, gases and ices are referred to as volatiles. The boundary in the Solar System beyond which those volatile substances could condense is known as the frost line, which lies roughly 5 AU from the Sun. Within the Kuiper Belt, objects and planetesimals are composed mainly of these materials and rock.<br><br>
      <span class="highlight_text">Formation and Evolution:</span><br>
      ...
      The center, where most of the mass collected, became increasingly hotter than the surrounding disc. As the contracting nebula rotated faster, it began to flatten into a protoplanetary disc with a hot, dense protostar at the center. The planets formed by accretion from this disc, in which dust and gas gravitated together and coalesced to form ever larger bodies.<br>
      ...
      In contrast, the giant planets (Jupiter, Saturn, Uranus, and Neptune) formed beyond the point between the orbits of Mars and Jupiter where material is cool enough for volatile icy compounds to remain solid (i.e. the frost line).<br>
      ...
      At this point, the Sun became a main-sequence star. Solar wind from the Sun created the heliosphere and swept away the remaining gas and dust from the protoplanetary disc into interstellar space, ending the planetary formation process.<br>
      ...
      <span class="highlight_text">Inner Solar System:</span><br>
      In the inner Solar System, we find the “Inner Planets” – <nuxt-link to="planets/mercury">Mercury</nuxt-link>, <nuxt-link to="planets/venus">Venus</nuxt-link>, <nuxt-link to="planets/earth">Earth</nuxt-link>, and <nuxt-link to="planets/mars">Mars</nuxt-link> – which are so named because they orbit closest to the Sun. In addition to their proximity, these planets have a number of key differences that set them apart from planets elsewhere in the Solar System.
      ...
      Like the other terrestrial planets, Earth has a rocky surface with mountains and canyons, and a heavy metal core. Earth’s atmosphere contains water vapor, which helps to moderate daily temperatures. Like Mercury, the Earth has an internal magnetic field. And our Moon, the only one we have, is comprised of a mixture of various rocks and minerals.<br>
      Mars is the fourth and final inner planet, and is also known as the “Red Planet” due to the oxidization of iron-rich materials that form the planet’s surface. Mars also has some of the most interesting terrain features of any of the terrestrial planets. These include the largest mountain in the Solar System (Olympus Mons) which rises some 21,229 m (69,649 ft) above the surface, and a giant canyon called Valles Marineris – which is 4000 km (2500 mi) long and reaches depths of up to 7 km (4 mi).<br><br>
      <span class="highlight_text">Outer Solar System:</span><br>
      The outer planets (sometimes called Jovian planets or gas giants) are huge planets swaddled in gas that have rings and plenty of moons.<br>
      Despite their size, only two of them are visible without telescopes: Jupiter and Saturn. Uranus and Neptune were the first planets discovered since antiquity, and showed astronomers that the solar system was bigger than previously thought.<br>
      <nuxt-link to="planets/jupiter">Jupiter</nuxt-link> is the largest planet in our Solar System and spins very rapidly (10 Earth hours) relative to its orbit of the sun (12 Earth years). Its thick atmosphere is mostly made up of hydrogen and helium, perhaps surrounding a terrestrial core that is about Earth’s size. The planet has dozens of moons, some faint rings and a Great Red Spot – a raging storm that has happening for the past 400 years at least.<br>
      <nuxt-link to="planets/saturn">Saturn</nuxt-link> is best known for its prominent ring system – seven known rings with well-defined divisions and gaps between them. How the rings got there is one subject under investigation. It also has dozens of moons. Its atmosphere is mostly hydrogen and helium, and it also rotates quickly (10.7 Earth hours) relative to its time to circle the Sun (29 Earth years).<br>
      <nuxt-link to="planets/uranus">Uranus</nuxt-link> was first discovered by William Herschel in 1781. The planet’s day takes about 17 Earth hours and one orbit around the Sun takes 84 Earth years. Its mass contains water, methane, ammonia, hydrogen and helium surrounding a rocky core. It has dozens of moons and a faint ring system. The only spacecraft to visit this planet was the Voyager 2 spacecraft in 1986.<br>
      <nuxt-link to="planets/neptune">Neptune</nuxt-link> is a distant planet that contains water, ammmonia, methane, hydrogen and helium and a possible Earth-sized core. It has more than a dozen moons and six rings. NASA’s Voyager 2 spacecraft also visited this planet and its system by 1989 during its transit of the outer Solar System.<br><br>
      <img src="../assets/img/solar/moons_of_solar_system.jpg" class="img-fluid moons-img"/><br><br>
      <span class="highlight_text">Trans-Neptunian Region:</span><br>
      ...
      Keeping Pluto company out in the Kuiper belt are many other objects worthy of mention. Quaoar, Makemake, Haumea, Orcus and Eris are all large icy bodies in the Belt and several of them even have moons of their own. These are all tremendously far away, and yet, very much within reach.<br><br>
      <span class="highlight_text">Oort Cloud and Farthest Regions:</span><br>
      ...
      The outer Oort cloud may have trillions of objects larger than 1 km (0.62 mi), and billions that measure 20 kilometers (12 mi) in diameter. Its total mass is not known, but – assuming that Halley’s Comet is a typical representation of outer Oort Cloud objects – it has the combined mass of roughly 3×1025 kilograms (6.6×1025 pounds), or five Earths.<br><br>
      <img src="../assets/img/solar/oort-cloud.jpg" class="img-fluid oort-img"/><br><br>
      Based on the analyses of past comets, the vast majority of Oort Cloud objects are composed of icy volatiles – such as water, methane, ethane, carbon monoxide, hydrogen cyanide, and ammonia. The appearance of asteroids thought to be originating from the Oort Cloud has also prompted theoretical research that suggests that the population consists of 1-2% asteroids.<br>
      Earlier estimates placed its mass up to 380 Earth masses, but improved knowledge of the size distribution of long-period comets has led to lower estimates.<br>
      The mass of the inner Oort Cloud, meanwhile, has yet to be characterized. The contents of both Kuiper Belt and the Oort Cloud are known as Trans-Neptunian Objects (TNOs), because the objects of both regions have orbits that that are further from the Sun than Neptune’s orbit.
      </h6>
    </div>
    <section id="images">
      <div>
        <img class="img-fluid" src="../assets/img/solar/beyond_solar.jpg" alt="Earth">
        <p class="highlight_text">Beyond our Solar System</p>
      </div>
      <div>
...
@media screen and (min-width: 991px) {
  #solar {
    ...
    grid-template-rows: 80px 320px auto 450px;
